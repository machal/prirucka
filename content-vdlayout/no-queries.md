...
Responzivní obrázková galerie je opět založena pouze na definici šířky sloupce s pomocí `column-width`. Zde je řešení obohacené také o vlastnost `break-inside:avoid`, což zabrání zalomení sloupečku uvnitř položky galerie. [vrdl.in/hwpmx](https://codepen.io/machal/pen/rraAgj?editors=1100)
