...
Ve specifikaci AMP HTML je řada běžných značek zakázaná a neexistují pro ně náhrady. Jde například o `<base>`, `<frame>`, `<object>`, `<embed>` a řadu dalších. Jak je ale vidět, v tomto seznamu jde o značky, jež mají nejlepší léta za sebou. Z pohledu výkonu při vykreslování stránky je to pochopitelné. Když budete dělat nábor do atletického kroužku, nepůjdete přeci do klubu seniorů.
